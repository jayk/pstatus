...
const snapshot = { projects: [{ name: "Vouchsafe", records: [
  { status: "TODO", title: "Write article", body: "About revocation", date: "2026-08-20", metadata: { type: "write", tag: ["blog", "security"] }, derived: { etaMinutes: 90 } },
  { status: "DONE", title: "Old work", body: "", date: "2026-08-10", metadata: {}, derived: {} }
] }] };
